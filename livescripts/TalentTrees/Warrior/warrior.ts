...
export function ReloadWarrTree() {
    ...
    SetTalentNode(Talent, TAB, 4, 1, 0, false, false, CreateArray<uint32>([Talent]), EmptyPrereqs, EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-gen-heroic-leap')
    SetTalentNode(Talent, TAB, 6, 1, 0, false, false, CreateArray<uint32>([Talent]), EmptyPrereqs, EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-gen-war-machine')
    SetTalentNode(Talent, TAB, 3, 2, 0, true, false, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-gen-victory-rush`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-gen-sieze-the-day')
    SetTalentNode(Talent, TAB, 4, 2, 0, true, false, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-gen-victory-rush`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-gen-rallying-cry')
    SetTalentNode(Talent, TAB, 5, 2, 0, true, false, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-gen-victory-rush`)]: 1, [GetID(`Spell`, 'dh-spells', 'warr-gen-heroic-leap')]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-gen-heroic-entrance')
    SetTalentNode(Talent, TAB, 6, 2, 0, true, false, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-gen-heroic-leap`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-gen-blitz')
    SetTalentNode(Talent, TAB, 7, 2, 0, true, false, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-gen-heroic-leap`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-gen-anger-management')
    SetTalentNode(Talent, TAB, 2, 3, 0, true, false, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-gen-war-machine`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-gen-stormbolt')
    SetTalentNode(Talent, TAB, 4, 3, 0, false, false, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, 'warr-gen-sieze-the-day')]: 1, [GetID(`Spell`, 'dh-spells', 'warr-gen-rallying-cry')]: 1}), EmptySpellArray, EmptySpellArray)
