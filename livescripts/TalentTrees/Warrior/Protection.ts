...
export function ReloadWarriorProtTree() {
    ...
    SetTalentNode(Talent, TAB, 3, 5, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-loudmanagement`)]: 1, [GetID(`Spell`, `dh-spells`, `warr-pro-galvanized`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-shieldcharge')
    SetTalentNode(Talent, TAB, 6, 5, 0, false, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-swordandboard`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-defensivemaneuvers')
    SetTalentNode(Talent, TAB, 9, 5, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-fewstoodagainstmany`)]: 1, [GetID(`Spell`, `dh-spells`, `warr-pro-shieldmastery`)]: 1}), EmptySpellArray, EmptySpellArray)
    
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-staticcontact')
    SetTalentNode(Talent, TAB, 2, 6, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-thunderlord`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-thunderousblow')
    SetTalentNode(Talent, TAB, 4, 6, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-thunderlord`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-batteringram')
    SetTalentNode(Talent, TAB, 5, 6, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-shieldcharge`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-violentoutburst')
    SetTalentNode(Talent, TAB, 6, 6, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-shieldcharge`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-breakingstrikes')
    SetTalentNode(Talent, TAB, 7, 6, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-shieldcharge`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-citicalblock')
    SetTalentNode(Talent, TAB, 8, 6, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-defensivemaneuvers`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-shieldbash')
    SetTalentNode(Talent, TAB, 10, 6, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-defensivemaneuvers`)]: 1}), EmptySpellArray, EmptySpellArray)
    
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-secretofsteel')
    SetTalentNode(Talent, TAB, 3, 7, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-staticcontact`)]: 1, [GetID(`Spell`, `dh-spells`, `warr-pro-thunderousblow`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-revengeofthegladiator')
    SetTalentNode(Talent, TAB, 5, 7, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-thunderousblow`)]: 1, [GetID(`Spell`, `dh-spells`, `warr-pro-batteringram`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-indomitable')
    SetTalentNode(Talent, TAB, 6, 7, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-batteringram`)]: 1, [GetID(`Spell`, `dh-spells`, `warr-pro-violentoutburst`)]: 1, [GetID(`Spell`, `dh-spells`, `warr-pro-breakingstrikes`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-removethehead')
    SetTalentNode(Talent, TAB, 7, 7, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-breakingstrikes`)]: 1, [GetID(`Spell`, `dh-spells`, `warr-pro-citicalblock`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'warr-pro-secretofflesh')
    SetTalentNode(Talent, TAB, 9, 7, 0, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `warr-pro-citicalblock`)]: 1, [GetID(`Spell`, `dh-spells`, `warr-pro-shieldbash`)]: 1}), EmptySpellArray, EmptySpellArray)
}