...
export function ReloadPalTree() {
    ...
    SetTalentNode(Talent, TAB, 2, 1, 0, false, 2**(SpecTabs.HPAL - 1), CreateArray<uint32>([Talent]), EmptyPrereqs, EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, `dh-spells`, `pal-gen-divinesteed`)
    SetTalentNode(Talent, TAB, 5, 1, 0, false, 2**(SpecTabs.PPAL - 1), CreateArray<uint32>([Talent]), EmptyPrereqs, EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, `dh-spells`, `pal-gen-exorcism`)
    SetTalentNode(Talent, TAB, 8, 1, 0, false, 2**(SpecTabs.RPAL - 1), CreateArray<uint32>([Talent]), EmptyPrereqs, EmptySpellArray, EmptySpellArray)
