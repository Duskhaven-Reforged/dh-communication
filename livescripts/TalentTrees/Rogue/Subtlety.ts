...
export function ReloadRogueSubTree() {
    ...
    SetTalentNode(Talent, TAB, 3, 5, 8, false, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `rog-sub-wellaimedblades`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'rog-sub-thefirstdance')
    SetChoiceNode(Talent, TAB, 4, 5, 8, true, CreateArray<uint32>([Talent, GetID(`Spell`, 'dh-spells', 'rog-sub-masterofshadows')]), CreateDictionary<uint32, uint8>({[GetID('Spell', 'dh-spells', 'rog-sub-relentlessstrikes')]: 1, [GetID('Spell', 'dh-spells', 'rog-sub-wellaimedblades')]: 1}), EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'rog-sub-deepeningshadows')
    SetTalentNode(Talent, TAB, 5, 5, 8, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `rog-sub-relentlessstrikes`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'rog-sub-stabandtear')
    SetTalentNode(Talent, TAB, 6, 5, 8, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `rog-sub-improvedgloomblade`)]: 1, [GetID(`Spell`, `dh-spells`, `rog-sub-relentlessstrikes`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'rog-sub-symbolsofdeath')
    SetTalentNode(Talent, TAB, 7, 5, 8, false, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `rog-sub-improvedgloomblade`)]: 1}), EmptySpellArray, EmptySpellArray)
    ...
    SetTalentNode(Talent, TAB, 7, 6, 8, false, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `rog-sub-stabandtear`)]: 1, [GetID(`Spell`, `dh-spells`, `rog-sub-thefirstdance`)]: 1, [GetID(`Spell`, `dh-spells`, `rog-sub-deepeningshadows`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'rog-sub-veiltouched')
    SetTalentNode(Talent, TAB, 8, 6, 8, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `rog-sub-stabandtear`)]: 1, [GetID(`Spell`, `dh-spells`, `rog-sub-symbolsofdeath`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'rog-sub-shotinthedark')
    SetTalentNode(Talent, TAB, 9, 6, 8, true, 0, CreateArray<uint32>([Talent]), CreateDictionary<uint32, uint8>({[GetID(`Spell`, `dh-spells`, `rog-sub-symbolsofdeath`)]: 1}), EmptySpellArray, EmptySpellArray)
    Talent = GetID(`Spell`, 'dh-spells', 'rog-sub-plannedexecution')
    SetChoiceNode(Talent, TAB, 6, 6, 8, true, CreateArray<uint32>([Talent, GetID(`Spell`, 'dh-spells', 'rog-sub-warningsigns')]), CreateDictionary<uint32, uint8>({[GetID('Spell', 'dh-spells', 'rog-sub-symbolsofdeath')]: 1}), EmptySpellArray)
