...
(2,@POOL+2,@MOTHER,0,'test');
    ...
    std.SQL.Databases.world_dest.writeEarly(`
        ...
        CREATE TABLE IF NOT EXISTS \`forge_talent_tabs\` (
            ...
            INSERT INTO \`forge_talent_tabs\` (\`id\`, \`classMask\`, \`raceMask\`, \`name\`, \`spellIcon\`, \`background\`, \`description\`, \`role\`, \`spellString\`, \`tabType\`, \`TabIndex\`) VALUES (11, 8, 32767, 'Corsair', 53, 'SpecBG/rogue-combat', 'A ruthless fugitive who uses agility and guile to stand toe-to-toe with enemies.\r\n\r\nPreferred Weapon: Axes, Maces, Swords, Fist Weapons\r\nPrimary Stat: Agility', '1', '48657, 13877, 11305', 0, 97);
            ...
            INSERT INTO \`forge_talent_tabs\` (\`id\`, \`classMask\`, \`raceMask\`, \`name\`, \`spellIcon\`, \`background\`, \`description\`, \`role\`, \`spellString\`, \`tabType\`, \`TabIndex\`) VALUES (33, 16, 32767, 'Inquisition', 47788, 'SpecBG/priest-holy', 'Soon', '1', '0', 0, 99);
