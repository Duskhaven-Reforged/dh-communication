...
function ActionButton_UpdateUsable (self)
	...
	local CheckActionCustomUsable = require('TSAddons.dh-communication.addon.dh-ui.dh-actions.ActionBarInjects')
	isUsable = CheckActionCustomUsable.IsActionUsable(isUsable, spellID)
	if ( isUsable ) then
