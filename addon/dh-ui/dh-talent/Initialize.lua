...
tstl_register_module(
    "TSAddons.dh-communication.addon.dh-message.Components.TalentTree.Initialize",
    function ()
        local exports = {}

        function exports.GetTalentTreeLayout(msg)
        ...
        function exports.GetCharacterSpecs(msg)
        ...
        function exports.LoadTalentString(msg)
        ...
        function exports.GetLoadouts(msg)
